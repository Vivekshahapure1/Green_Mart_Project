...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		System.out.println("jwtrequest");
								//got username and pass and authenticated
		...
		//if authentication is right jwt token will be created
		//to generate token call util object and pass authentication
		
		String jwt = jwtUtils.generateJwtToken(authentication);	//give generated token to jwt obj
		
		//if username password currect generate token
...
//	}
	...
	public ResponseEntity<?> registerUserAddress(@Valid @RequestBody Address request, @PathVariable long userId) {
